    ...
    <div class="tm-main-section light-gray-bg">
      <div class="container" id="main">
        <section class="tm-section tm-section-margin-bottom-0 row">
          ...
          <th></th>
          <th><input type="number" name="Room_no"></input></th>
          <th><input type="text" name="Checkin_time"></input></th>
          <th></th>
          <th><input type="text" name="Checkout_price"></input></th>
          ...
          while($checkouts=mysqli_fetch_assoc($query)){
          echo "<tr>";
          echo "<td align='center'>".$checkouts['Checkout_code']."</td>";
          echo "<td align='center'>".$checkouts['Room_no']."</td>";
          echo "<td align='center'>".$checkouts['Checkin_time']."</td>";
          echo "<td align='center'>".$checkouts['Checkout_time']."</td>";
          echo "<td align='center'>".$checkouts['Checkout_price']."</td>";
		  echo "<td align='center'>"."<a href='checkout_delete.php?del=$checkouts[Checkout_code]'>"."DELETE"."</a>"." | "."<a href='checkout_edit.php?edit=$checkouts[Checkout_code]'>"."EDIT"."</a>";;
          echo "</tr>";
          }
          ?>        
</table>

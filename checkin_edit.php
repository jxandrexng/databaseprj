    ...
    <div class="tm-main-section light-gray-bg">
      <div class="container" id="main">
        <section class="tm-section tm-section-margin-bottom-0 row">
          ...
          <tr>
          <form action="checkin_edit1.php" method="POST">
          <th><?php echo $checkins['Checkin_code']; ?></th>
           <input type="hidden" name="Checkin_code" value="<?php echo $checkins['Checkin_code']; ?>">
          <th><input type="text" name="newGuest_name" value="<?php echo $checkins['Guest_name']; ?>"></input></th>
          <th><input type="text" name="newGuest_address" value="<?php echo $checkins['Guest_address']; ?>"></input></th>
          <th><input type="number" name="newRoom_number" value="<?php echo $checkins['Room_number']; ?>"></input></th>
          <th><select name="newRoom_type" >
          ...
          <th><?php echo $checkins['Checkin_time']; ?></th>
          <th><input type="number" name="newRes_code" value="<?php echo $checkins['Res_code']; ?>"></input></th>

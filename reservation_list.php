    ...
    <div class="tm-main-section light-gray-bg">
      <div class="container" id="main">
        <section class="tm-section tm-section-margin-bottom-0 row">
          ...
          <th>Timestamp of Reservation</th>
          <th>Action</th>
          ...
          echo "<tr>";
          echo "<td align='center'>".$reservation['Res_code']."</td>";
          echo "<td align='center'>".$reservation['Guest_name']."</td>";
          echo "<td align='center'>".$reservation['email_address']."</td>";
          echo "<td align='center'>".$reservation['No_of_guests']."</td>";
          echo "<td align='center'>".$reservation['Room_type']."</td>";
          echo "<td align='center'>".$reservation['Arrival_date']."</td>";
          echo "<td align='center'>".$reservation['Arrival_time']."</td>";
          echo "<td align='center'>".$reservation['Depart_date']."</td>";
          echo "<td align='center'>".$reservation['Pickup_status']."</td>";
          echo "<td align='center'>".$reservation['Spec_requests']."</td>";
          echo "<td align='center'>".$reservation['Res_time']."</td>";
		  echo "<td align='center'>"."<a href='reservation_delete.php?del=$reservation[Res_code]'>"."DELETE"."</a>";
          echo "</tr>";
          }
          ?>
